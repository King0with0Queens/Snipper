...
'               |_|           ',  
    ...
    print(f'{lg}   Version: {w}0.36.90{lg} | Author: {w}@Technology Hub On YouTube{rs}\n')
    print(f'{lg} Now You Will Be Redirected To YouTube And A Video Will Play You Must Like And Subscribe It\n')
    print(f'{r}{r}Else This Script Wont Work')

os.system("termux-open-url https://youtu.be/4gXGrAsxWlE")
time.sleep(10)
